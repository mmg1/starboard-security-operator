...
type ScannerAquaCSP struct {
	Version  string `env:"OPERATOR_SCANNER_AQUA_CSP_VERSION" envDefault:"4.6.20166"`
	Host     string `env:"OPERATOR_SCANNER_AQUA_CSP_HOST" envDefault:"http://csp-console-svc.aqua:8080"`
	User     string `env:"OPERATOR_SCANNER_AQUA_CSP_USER"`
